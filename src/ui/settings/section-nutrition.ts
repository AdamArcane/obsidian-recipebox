 ...
 * display mode and value source. Collapsed by default since most users never
 * need to touch it. Property names live in the consolidated "Property names"
 * section.
 */
...
export function renderSectionNutrition(
	...
	createCollapsibleSection(container, "Nutrition", (body) => {
		new Setting(body)
